...
-------------------------------
DBM = {
	Revision = tonumber(("$Revision: 17695 $"):sub(12, -3)),
	DisplayVersion = "8.0.2", -- the string that is shown as version
	ReleaseRevision = 17695 -- the revision of the latest stable version that is available
}
