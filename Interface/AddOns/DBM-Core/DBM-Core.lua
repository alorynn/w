...
-------------------------------
DBM = {
	Revision = tonumber(("$Revision: 16198 $"):sub(12, -3)),
	DisplayVersion = "7.2.5", -- the string that is shown as version
	ReleaseRevision = 16198 -- the revision of the latest stable version that is available
}
