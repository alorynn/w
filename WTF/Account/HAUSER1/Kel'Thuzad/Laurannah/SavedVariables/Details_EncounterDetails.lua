...
EncounterDetailsDB = {
	["emotes"] = {
		...
		}, -- [1]
		{
			...
			{
				100.805000000051, -- [1]
				"Fetid Devourer has successfully |TInterface\\ICONS\\Ability_Creature_Poison_01.blp:20|t used |cFFFF0000|Hspell:262370|h[Consume Corruption]|h|r! Be sure to kill Corruption Corpuscles when they spawn!", -- [2]
				"Fetid Devourer", -- [3]
				1, -- [4]
			}, -- [4]
			{
